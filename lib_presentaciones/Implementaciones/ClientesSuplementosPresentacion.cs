...
namespace lib_presentaciones.Implementaciones
{
    public class ClientesSuplementosPresentacion : IClientesSuplementosPresentacion
    {
        ...
        public async Task<List<ClientesSuplementos>> Listar()
        {
        ...
        //public async Task<List<ClientesSuplementos>> PorTipo(ClientesSuplementos? entidad)
        //{
        //    var lista = new List<ClientesSuplementos>();
        //    var datos = new Dictionary<string, object>();
        ...
        //    comunicaciones = new Comunicaciones();
        //    datos = comunicaciones.ConstruirUrl(datos, "ClientesSuplementos/PorTipo");
        //    var respuesta = await comunicaciones!.Ejecutar(datos);
        ...
        public async Task<ClientesSuplementos?> Guardar(ClientesSuplementos? entidad)
        {
            if (entidad!.Id != 0)
            {
        ...
        public async Task<ClientesSuplementos?> Modificar(ClientesSuplementos? entidad)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
        ...
        public async Task<ClientesSuplementos?> Borrar(ClientesSuplementos? entidad)
        {
            if (entidad!.Id == 0)
            {
                throw new Exception("lbFaltaInformacion");
