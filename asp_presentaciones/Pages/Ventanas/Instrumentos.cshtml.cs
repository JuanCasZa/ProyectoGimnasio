...
namespace asp_presentacion.Pages.Ventanas
{
    ...
    {
        private IInstrumentosPresentacion? iPresentacion = null;

        public InstrumentosModel(IInstrumentosPresentacion iPresentacion)
        {
            try
            {
                this.iPresentacion = iPresentacion;
                Filtro = new Instrumentos()
                {
        ...
        [BindProperty] public Instrumentos? Actual { get; set; }
        [BindProperty] public Instrumentos? Filtro { get; set; }
        [BindProperty] public List<Instrumentos>? Lista { get; set; }
        ...
        public void OnPostBtRefrescar()
        {
            try
            {
                ...
                Filtro!.NombreInstrumento = Filtro!.NombreInstrumento ?? "";
