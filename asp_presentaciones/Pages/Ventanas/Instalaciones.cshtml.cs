...
{
    public class InstalacionesModel : PageModel
    {
        private IInstalacionesPresentacion? iPresentacion = null;

        public InstalacionesModel(IInstalacionesPresentacion iPresentacion)
        {
            try
            {
        ...
        [BindProperty] public Instalaciones? Actual { get; set; }
        [BindProperty] public Instalaciones? Filtro { get; set; }
        [BindProperty] public List<Instalaciones>? Lista { get; set; }
        ...
        public void OnPostBtRefrescar()
        {
            try
            {
                ...
                Filtro ??= new Instalaciones();

                Filtro!.Direccion = Filtro!.Direccion ?? "";
