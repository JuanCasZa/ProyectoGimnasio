...
{
    [TestClass]
    public class ClientesSuplementosAplicacionPrueba
    {
        private readonly IConexion iConexion;
        private readonly ClientesSuplementosAplicacion aplicacion;
        private ClientesSuplementos? entidad;

        public ClientesSuplementosAplicacionPrueba()
        {
            iConexion = new Conexion();
            iConexion.StringConexion = Configuracion.ObtenerValor("StringConexion");
            aplicacion = new ClientesSuplementosAplicacion(iConexion);
        }
        ...
        public bool Guardar()
        {
            entidad = new ClientesSuplementos
            {
                IdClientes = 1,
                IdSuplementos = 1
            };
