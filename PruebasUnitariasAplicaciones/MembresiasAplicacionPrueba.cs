...
{
    [TestClass]
    public class MembresiasAplicacionPrueba
    {
        private readonly IConexion? iConexion;
        private MembresiasAplicacion? aplicacion;
        private List<Membresias>? lista;
        private Membresias? entidad;

        public MembresiasAplicacionPrueba()
        {
            iConexion = new Conexion();
            iConexion.StringConexion = Configuracion.ObtenerValor("StringConexion");
            aplicacion = new MembresiasAplicacion(iConexion);
        }
        ...
        public bool Guardar()
        {
            this.entidad = EntidadesNucleo.Membresias()!;
        ...
        {
            this.entidad!.TipoMembresia = "Básica";
