...
namespace asp_servicios.Controllers
{
    ...
    public class InstalacionesEmpleadosController : ControllerBase
    {
        ...
        [HttpPost]
        public string PorIdInstalaciones()
        {
            var respuesta = new Dictionary<string, object>();
            try
            {
                ...
                respuesta["Entidades"] = this.iAplicacion!.PorIdInstalaciones(entidad);
                respuesta["Respuesta"] = "OK";
                respuesta["Fecha"] = DateTime.Now.ToString();
                return JsonConversor.ConvertirAString(respuesta);
            }
        ...
        public string PorIdEmpleados()
        {
            ...
            try
            {
                ...
                respuesta["Entidades"] = this.iAplicacion!.PorIdEmpleados(entidad);
                respuesta["Respuesta"] = "OK";
                respuesta["Fecha"] = DateTime.Now.ToString();
                return JsonConversor.ConvertirAString(respuesta);
            }
