...
namespace asp_servicios.Controllers
{
    ...
    public class BeneficiosMembresiasController : ControllerBase
    {
        ...
        public BeneficiosMembresiasController(IBeneficiosMembresiasAplicacion? iAplicacion, TokenAplicacion iAplicacionToken, AuditoriasAplicacion? iAplicacionAuditoria)
        {
        ...
        public string Guardar()
        {
            ...
            try
            {
                ...
                iAplicacionAuditoria!.AgregarAuditoria(iAplicacionToken!.GetAuditoria(), iAplicacionToken!.GetUsuario(datos["Llave"].ToString()!), iAplicacion.ToStringBeneficiosMembresias(entidad!), 1);
        ...
        public string Modificar()
        {
            ...
            try
            {
                ...
                iAplicacionAuditoria!.AgregarAuditoria(iAplicacionToken!.GetAuditoria(), iAplicacionToken!.GetUsuario(datos["Llave"].ToString()!), iAplicacion.ToStringBeneficiosMembresias(entidad!), 2);
        ...
        public string Borrar()
        {
            ...
            try
            {
                ...
                iAplicacionAuditoria!.AgregarAuditoria(iAplicacionToken!.GetAuditoria(), iAplicacionToken!.GetUsuario(datos["Llave"].ToString()!), iAplicacion.ToStringBeneficiosMembresias(entidad!), 3);
