...
namespace asp_servicios.Controllers
{
    ...
    {
        private IInstalacionesAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;
        private AuditoriasAplicacion? iAplicacionAuditoria = null;

        public InstalacionesController(IInstalacionesAplicacion? iAplicacion, TokenAplicacion iAplicacionToken, AuditoriasAplicacion? iAplicacionAuditoria)
        {
